...
def setup_urls(application: flask.Flask):
    ...
    application.add_url_rule('/sell', view_func=assets.AssetsListView.as_view('sell_view'))
    application.add_url_rule('/buy', view_func=assets.AssetsListView.as_view('buy_view'))
